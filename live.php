...
<div class="container">
  ...
  <?php if (empty($items)): ?>
  <p class="ar-text" style="color: var(--mid); line-height: 1.7;">متابعة البثوث المباشرة للأحداث. المحتوى قيد الإعداد.</p>
  <p class="fr-text" style="color: var(--mid); line-height: 1.7;">Suivez les émissions et événements en direct. Contenu en cours de préparation.</p>
  <?php else: ?>
