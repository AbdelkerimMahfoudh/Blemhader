...
<div class="container">
  ...
  <?php if (empty($items)): ?>
  <p class="ar-text" style="color: var(--mid); line-height: 1.7;">أخبار الاقتصاد والمالية. المحتوى قيد الإعداد.</p>
  <p class="fr-text" style="color: var(--mid); line-height: 1.7;">Actualité économique et financière. Contenu en cours de préparation.</p>
  <?php else: ?>
