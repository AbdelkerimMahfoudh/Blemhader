...
<div class="container">
  ...
  <?php if (empty($items)): ?>
  <p class="ar-text" style="color: var(--mid); line-height: 1.7;">لقاءات وحوارات مع الشخصيات. المحتوى قيد الإعداد.</p>
  <p class="fr-text" style="color: var(--mid); line-height: 1.7;">Rencontres et entretiens. Contenu en cours de préparation.</p>
  <?php else: ?>
